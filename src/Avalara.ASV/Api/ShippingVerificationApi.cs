    ...
    public partial class ShippingVerificationApi : IShippingVerificationApi
    {
        ...
        public ShippingVerificationApi(string basePath)
        {
            this.Configuration = Avalara.ASV.Client.Configuration.MergeConfigurations(
                ...
                new Avalara.ASV.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Avalara.ASV.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Avalara.ASV.Client.ApiClient(this.Configuration.BasePath);
        ...
        /// <returns></returns>
        public ShippingVerificationApi(Avalara.ASV.Client.Configuration configuration)
        {
            ...
            this.Client = new Avalara.ASV.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Avalara.ASV.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Avalara.ASV.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public ShippingVerificationApi(Avalara.ASV.Client.ISynchronousClient client, Avalara.ASV.Client.IAsynchronousClient asyncClient, Avalara.ASV.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Avalara.ASV.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Avalara.ASV.Client.ISynchronousClient Client { get; set; }
