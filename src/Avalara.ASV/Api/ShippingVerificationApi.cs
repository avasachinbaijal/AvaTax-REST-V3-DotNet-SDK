...
namespace Avalara.ASV.Api
{
    ...
    public partial class ShippingVerificationApi : IShippingVerificationApiSync, IShippingVerificationApiAsync
    {
        ...
        /// <param name="documentType">(Optional): The document type of the transaction to operate on. If omitted, defaults to \&quot;SalesInvoice\&quot; (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Avalara.ASV.Client.ApiResponse<Object> DeregisterShipmentWithHttpInfo(string companyCode, string transactionCode, string documentType = default(string))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->DeregisterShipment");

            // verify the required parameter 'transactionCode' is set
            if (transactionCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'transactionCode' when calling ShippingVerificationApi->DeregisterShipment");
            ...
            localVarRequestOptions.PathParameters.Add("companyCode", Avalara.ASV.Client.ClientUtils.ParameterToString(companyCode)); // path parameter
            localVarRequestOptions.PathParameters.Add("transactionCode", Avalara.ASV.Client.ClientUtils.ParameterToString(transactionCode)); // path parameter
            if (documentType != null)
            {
                localVarRequestOptions.QueryParameters.Add(Avalara.ASV.Client.ClientUtils.ParameterToMultiMap("", "documentType", documentType));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Avalara.ASV.Client.ApiResponse<Object>> DeregisterShipmentWithHttpInfoAsync(string companyCode, string transactionCode, string documentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->DeregisterShipment");
        ...
        /// <param name="documentType">(Optional): The document type of the transaction to operate on. If omitted, defaults to \&quot;SalesInvoice\&quot; (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Avalara.ASV.Client.ApiResponse<Object> RegisterShipmentWithHttpInfo(string companyCode, string transactionCode, string documentType = default(string))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->RegisterShipment");

            // verify the required parameter 'transactionCode' is set
            if (transactionCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'transactionCode' when calling ShippingVerificationApi->RegisterShipment");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Avalara.ASV.Client.ApiResponse<Object>> RegisterShipmentWithHttpInfoAsync(string companyCode, string transactionCode, string documentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->RegisterShipment");
        ...
        /// <param name="documentType">(Optional): The document type of the transaction to operate on. If omitted, defaults to \&quot;SalesInvoice\&quot; (optional)</param>
        /// <returns>ApiResponse of ShippingVerifyResult</returns>
        public Avalara.ASV.Client.ApiResponse<ShippingVerifyResult> RegisterShipmentIfCompliantWithHttpInfo(string companyCode, string transactionCode, string documentType = default(string))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->RegisterShipmentIfCompliant");

            // verify the required parameter 'transactionCode' is set
            if (transactionCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'transactionCode' when calling ShippingVerificationApi->RegisterShipmentIfCompliant");
        ...
        /// <param name="documentType">(Optional): The document type of the transaction to operate on. If omitted, defaults to \&quot;SalesInvoice\&quot; (optional)</param>
        /// <returns>ApiResponse of ShippingVerifyResult</returns>
        public Avalara.ASV.Client.ApiResponse<ShippingVerifyResult> VerifyShipmentWithHttpInfo(string companyCode, string transactionCode, string documentType = default(string))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->VerifyShipment");

            // verify the required parameter 'transactionCode' is set
            if (transactionCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'transactionCode' when calling ShippingVerificationApi->VerifyShipment");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ShippingVerifyResult)</returns>
        public async System.Threading.Tasks.Task<Avalara.ASV.Client.ApiResponse<ShippingVerifyResult>> VerifyShipmentWithHttpInfoAsync(string companyCode, string transactionCode, string documentType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'companyCode' is set
            if (companyCode == null)
                throw new Avalara.ASV.Client.ApiException(400, "Missing required parameter 'companyCode' when calling ShippingVerificationApi->VerifyShipment");
