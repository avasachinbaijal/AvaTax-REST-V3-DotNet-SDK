...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class FeatureList :  IEquatable<FeatureList>
    {
        /// <summary>
        ...
        public FeatureList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Feature> items = default(List<Feature>))
        {
        ...
        {
            return this.Equals(input as FeatureList);
        }

        /// <summary>
        /// Returns true if FeatureList instances are equal
        /// </summary>
        /// <param name="input">Instance of FeatureList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeatureList input)
        {
            if (input == null)
                return false;
