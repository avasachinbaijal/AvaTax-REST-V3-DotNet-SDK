...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class SystemList :  IEquatable<SystemList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemList" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="nextLink">nextLink.</param>
        /// <param name="pageKey">pageKey.</param>
        /// <param name="items">items.</param>
        public SystemList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<System> items = default(List<System>))
        {
        ...
        public List<System> Items { get; set; }
        ...
        {
            return this.Equals(input as SystemList);
        }

        /// <summary>
        /// Returns true if SystemList instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemList input)
        {
            if (input == null)
                return false;
