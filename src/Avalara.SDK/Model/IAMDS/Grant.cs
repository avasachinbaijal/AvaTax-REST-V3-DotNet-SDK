...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    public partial class Grant :  IEquatable<Grant>
    {
        ...
        /// </summary>
        /// <value>Determines the grant ownership</value>
        ...
        /// Initializes a new instance of the <see cref="Grant" /> class.
        /// </summary>
        /// <param name="displayName">Name of the Grant (required).</param>
        /// <param name="description">Description of the grant, used for display purposes.</param>
        /// <param name="system">system (required).</param>
        /// <param name="type">Determines the grant ownership (required).</param>
        /// <param name="role">role (required).</param>
        /// <param name="rules">Defines the conditions associated with permissions in the role.</param>
        ...
        public Grant(string displayName = default(string), string description = default(string), Reference system = default(Reference), TypeEnum type = default(TypeEnum), Reference role = default(Reference), List<Object> rules = default(List<Object>), InstanceMeta meta = default(InstanceMeta), List<Aspect> aspects = default(List<Aspect>), List<Tag> tags = default(List<Tag>))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for Grant and cannot be null");
            }
            else
            {
            ...
            if (system == null)
            {
                throw new InvalidDataException("system is a required property for Grant and cannot be null");
            }
            else
            {
                this.System = system;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Grant and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (role == null)
            {
                throw new InvalidDataException("role is a required property for Grant and cannot be null");
            }
            else
            {
                this.Role = role;
        ...
        /// </summary>
        /// <value>Description of the grant, used for display purposes</value>
        ...
        /// </summary>
        /// <value>Defines the conditions associated with permissions in the role</value>
