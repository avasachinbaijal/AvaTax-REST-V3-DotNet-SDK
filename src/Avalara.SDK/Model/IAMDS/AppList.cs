...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppList :  IEquatable<AppList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppList" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="nextLink">nextLink.</param>
        /// <param name="pageKey">pageKey.</param>
        /// <param name="items">items.</param>
        public AppList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<App> items = default(List<App>))
        {
        ...
        {
            return this.Equals(input as AppList);
        }

        /// <summary>
        /// Returns true if AppList instances are equal
        /// </summary>
        /// <param name="input">Instance of AppList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppList input)
        {
            if (input == null)
                return false;
