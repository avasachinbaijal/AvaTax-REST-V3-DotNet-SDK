...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class PermissionList :  IEquatable<PermissionList>
    {
        /// <summary>
        ...
        public PermissionList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Permission> items = default(List<Permission>))
        {
        ...
        {
            return this.Equals(input as PermissionList);
        }

        /// <summary>
        /// Returns true if PermissionList instances are equal
        /// </summary>
        /// <param name="input">Instance of PermissionList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PermissionList input)
        {
            if (input == null)
                return false;
