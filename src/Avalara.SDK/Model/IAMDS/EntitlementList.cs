...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class EntitlementList :  IEquatable<EntitlementList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitlementList" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="nextLink">nextLink.</param>
        /// <param name="pageKey">pageKey.</param>
        /// <param name="items">items.</param>
        public EntitlementList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Entitlement> items = default(List<Entitlement>))
        {
        ...
        public List<Entitlement> Items { get; set; }
        ...
        {
            return this.Equals(input as EntitlementList);
        }

        /// <summary>
        /// Returns true if EntitlementList instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitlementList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitlementList input)
        {
            if (input == null)
                return false;
