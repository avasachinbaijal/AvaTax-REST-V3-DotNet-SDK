...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceList :  IEquatable<ResourceList>
    {
        /// <summary>
        ...
        public ResourceList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Resource> items = default(List<Resource>))
        {
        ...
        {
            return this.Equals(input as ResourceList);
        }

        /// <summary>
        /// Returns true if ResourceList instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceList input)
        {
            if (input == null)
                return false;
