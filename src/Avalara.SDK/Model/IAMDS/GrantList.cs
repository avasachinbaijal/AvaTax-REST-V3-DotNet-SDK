...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class GrantList :  IEquatable<GrantList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrantList" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="nextLink">nextLink.</param>
        /// <param name="pageKey">pageKey.</param>
        /// <param name="items">items.</param>
        public GrantList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Grant> items = default(List<Grant>))
        {
        ...
        public List<Grant> Items { get; set; }
        ...
        {
            return this.Equals(input as GrantList);
        }

        /// <summary>
        /// Returns true if GrantList instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantList input)
        {
            if (input == null)
                return false;
