...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupList :  IEquatable<GroupList>
    {
        /// <summary>
        ...
        public GroupList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Group> items = default(List<Group>))
        {
