...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleList :  IEquatable<RoleList>
    {
        /// <summary>
        ...
        public RoleList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Role> items = default(List<Role>))
        {
