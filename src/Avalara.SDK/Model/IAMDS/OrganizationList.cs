...
namespace Avalara.SDK.Model.IAMDS
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationList :  IEquatable<OrganizationList>
    {
        /// <summary>
        ...
        public OrganizationList(int recordsetCount = default(int), string nextLink = default(string), string pageKey = default(string), List<Organization> items = default(List<Organization>))
        {
