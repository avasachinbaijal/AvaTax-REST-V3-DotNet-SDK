...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class AgeVerificationApi : IAgeVerificationApiSync, IAgeVerificationApiAsync
    {
        ...
        /// </summary>
        public AgeVerificationApi(Org.OpenAPITools.Client.ApiClient client)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AgeVerifyResult> localVarResponse = VerifyAgeWithHttpInfo(ageVerifyRequest, simulatedFailureCode);
        ...
        private Org.OpenAPITools.Client.ApiResponse<AgeVerifyResult> VerifyAgeWithHttpInfo(AgeVerifyRequest ageVerifyRequest, AgeVerifyFailureCode? simulatedFailureCode = default(AgeVerifyFailureCode?))
        {
            // verify the required parameter 'ageVerifyRequest' is set
            if (ageVerifyRequest == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'ageVerifyRequest' when calling AgeVerificationApi->VerifyAge");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "simulatedFailureCode", simulatedFailureCode));
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AgeVerifyResult> localVarResponse = await VerifyAgeWithHttpInfoAsync(ageVerifyRequest, simulatedFailureCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
